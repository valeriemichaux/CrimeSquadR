...
importances.incl_SE %>%
  ...
  geom_col(fill= c("Speicherung" = "#adf7b6", "Datenpartikel" = "#ffee93", "Erklärbarkeit" = "#ffc09f",  "Ort"= "#a0ced9")) + 
...
#ggsave('data/importances_gender.png', width = 20, height = 10, units = "cm", dpi=300)
...
pwu%>%
 ...
 # stat_summary(fun = mean,
             #  geom = "pointrange",
              ...
              # fun.min = function(x) mean(x) - sd(x) / sqrt(length(x)), width= 0.2, size=.2, position = position_dodge(width =0.90))+
