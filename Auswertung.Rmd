...
pwu%>%
  ...
  #stat_summary(geom="text", aes(label=sprintf("%1.2f%%", ..y..)), size=3, position = position_dodge(width = 0.90)) +
...
#erstes Grüst, allerdings müsssen die Farben Skalenbeschriftungen noch angepasst werden 
